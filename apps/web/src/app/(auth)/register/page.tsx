    ...
    <div className="flex min-h-screen items-center justify-center bg-stone-50 px-4">
      <div className="w-full max-w-sm">
        <div className="mb-8 text-center">
          ...
          <p className="mt-1 text-sm text-stone-500">30 de zile gratuit, fără card</p>
        </div>

        <div className="rounded-2xl border border-stone-200 bg-white p-8 shadow-sm">
          <h2 className="mb-6 text-xl font-semibold text-stone-900">Creează cont gratuit</h2>
          ...
          <p className="mt-6 text-center text-sm text-stone-500">
            Ai deja cont?{' '}
            <Link href="/login" className="font-medium text-taxly-700 underline-offset-2 hover:text-taxly-800 hover:underline">
              Intră în cont
            </Link>
          </p>
        </div>
