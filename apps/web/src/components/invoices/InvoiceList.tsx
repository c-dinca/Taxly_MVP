...
export function InvoiceList({ token }: InvoiceListProps) {
  ...
  useEffect(() => {
    apiRequest<Invoice[]>('/api/invoices', { token })
      .then(setInvoices)
          ...
          <table className="w-full text-sm">
            ...
            <tbody>
              ...
              {filtered.map(inv => {
                ...
                return (
                  <tr key={inv._id} className="border-b border-[#F4F6FB] hover:bg-[#F4F6FB]/60 transition-colors">
